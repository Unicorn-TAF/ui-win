...
namespace Unicorn.UI.Desktop
{
    ...
    public class UiActions
    {
        ...
        public void DragAndDrop(GuiControl sourceControl, GuiControl targetControl)
        {
        ...
        public void SelectMultipleControls(params GuiControl[] controls)
        {
        ...
        public void SelectControlsRange(GuiControl startControl, GuiControl endControl)
        {
        ...
        private Point CenterOf(GuiControl control)
        {
